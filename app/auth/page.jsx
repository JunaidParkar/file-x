...
const Home = () => {
  ...
  let VerifyUI = () => {
    return (
      <>
        <div className='absolute w-[450px] bg-[#fff] left-[50%] translate-x-[-50%] duration-100 bottom-[50px] h-[345px] shadow-panda-body'>
              <div className='w-full h-full flex flex-col justify-center gap-[20px] text-center p-[30px] relative'>
                ...
                <div className='w-full text-center'>
                  <p>We have send you a verification link. Please verify your gmail before proceeding.</p>
                </div>

                <div className='w-full flex justify-center px-[30px]'>
                  <div className='w-full bg-[rgba(0,0,0,.2)] rounded-[25px] py-[5px] cursor-pointer'>
                    <p className='bg-transparent outline-none w-full px-[20px] py-[5px] pointer-events-none'>Re-send verification link?</p>
                  </div>
                </div>
  ...
  let FormUI = () => {
    return (
      <>
        <form className='absolute w-[450px] bg-[#fff] left-[50%] translate-x-[-50%] duration-100 shadow-panda-body' style={{ bottom: passwordFocus && passwordType == "password" ? "120px" : "50px", height: isSendVerify ? "345px" : action == "login" ? "345px" : "390px"}}>
  ...
  return (
    <>
      ...
      <div className='w-full h-full flex justify-center items-center bg-login-gradient-1'>
        <div className='w-max h-max'>
          ...
          <div className="bg-[#fff] rounded-panda-body w-[275px] shadow-panda-body relative z-[4]" style={{ height: isSendVerify ? "310px" : action == "login" ? "310px" : "340px" }}>

            {/* form here */}

            {isSendVerify ? <VerifyUI /> : <FormUI />}
